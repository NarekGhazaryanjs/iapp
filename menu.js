...
const contentTranslations = {
  ...
  hy: {
    ...
    "Founded in 1980, IAPP NAS RA is a leading scientific institution conducting fundamental and applied research in physics and related fields.":
      "Հիմնադրված 1980 թվականին՝ Կիրառական խնդիրների ֆիզիկայի ինստիտուտը առաջատար գիտական հաստատություն է, որը իրականացնում է հիմնարար և կիրառական հետազոտություններ ֆիզիկայի և հարակից ոլորտներում։",
    ...
    "position": "Պաշտոն",
    "Deputy Director for Science": "Տնօրենի տեղակալ գիտության գծով",
    "Scientific Secretary": "Գիտական քարտուղար",
    "Deputy Director for General Affairs": "Տնօրենի տեղակալ ընդհանուր հարցերով",
